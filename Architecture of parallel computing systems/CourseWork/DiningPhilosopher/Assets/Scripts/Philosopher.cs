...
public class Philosopher : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            random_thinking_time = (int)uicontroller.ThinkingSlider.value;
            random_eating_duration = (int)uicontroller.EatingSlider.value;
            random_pick_resource_duration = (int)uicontroller.PickUpSlider.value;
            random_drop_resource_duration = (int)uicontroller.DropSlider.value;
        }
