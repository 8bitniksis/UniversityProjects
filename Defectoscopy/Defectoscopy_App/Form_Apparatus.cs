...
{
    public partial class Form_Apparatus : Form
    {
        public Form_Apparatus()
        {
            InitializeComponent();
        }

        private void Form_Apparatus_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Validate();
                this.apparatusBindingSource.EndEdit();
                this.apparatusTableAdapter.Update(this.defectoscopyDataSet.apparatus);
